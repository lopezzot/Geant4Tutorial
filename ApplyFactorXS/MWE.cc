...
int main(int argc, char** argv)
{
  ...
  // Enable scaling of XS (default false)
  G4HadronicParameters::Instance()->SetApplyFactorXS(true);
  // Hadronic XS scaling only works +- 20%!
  // Scale nucleon (proton+neutron) inelastic XS
  G4HadronicParameters::Instance()->SetXSFactorNucleonInelastic(1.1);
  // Scale pion elastic XS
  G4HadronicParameters::Instance()->SetXSFactorPionElastic(0.88);
  // Scale other hadrons inelastic XS
